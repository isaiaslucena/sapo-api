...
def response_carbohydrate():
	cursor = mysql.connection.cursor()
	cursor.execute('''SELECT * FROM foods ORDER BY carbohydrate DESC LIMIT 1''')
...
def response_protein():
	cursor = mysql.connection.cursor()
	cursor.execute('''SELECT * FROM foods ORDER BY protein DESC LIMIT 1''')
...
def response_fat():
	cursor = mysql.connection.cursor()
	cursor.execute('''SELECT * FROM foods ORDER BY fat DESC LIMIT 1''')
